...
if __name__ == '__main__':
    ...
    for sim in range(simulations):
        ...
        iterations_list, throughput_list, cellular_trace, d2d_trace = compute(cell, 
                16, iterations_per_simulation, swap, 
                        caching=False, follow_trace=False)
        ...
        iterations_list, throughput_list, _, _ = compute(cell2, 16, 
                iterations_per_simulation, swap_new, caching=False, 
                    follow_trace=True, cellular_trace=cellular_trace, 
                    d2d_trace=d2d_trace)
    ...
    quad_display(iterations_list, average_throughput_list, 'b-', 'Swap', 
            average_throughput_list_1, 'b--', 'Swap_Cache', 
            average_throughput_list_2, 'r-', 'Swap_New', 
            average_throughput_list_3, 'r--', 'Swap_New_Cache', 
