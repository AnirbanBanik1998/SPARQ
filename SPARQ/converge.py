...
for sim in range(simulations):
    ...
    iterations_list, throughput_list, _, _ = compute(cell1, 16, 
            iterations_per_simulation, swap_new, smart_PC=True, caching=True, 
    ...
    iterations_list, throughput_list, _, _ = compute(cell2, 16, 
            iterations_per_simulation, swap_new, smart_PC=True, caching=True, 
                caching_parameter=6, follow_trace=True, 
                cellular_trace=cellular_trace, 
                d2d_trace=d2d_trace)
    ...
    iterations_list, throughput_list, _, _ = compute(cell3, 16, 
            iterations_per_simulation, swap_new, smart_PC=True, caching=True, 
                caching_parameter=8, follow_trace=True, 
                cellular_trace=cellular_trace, 
                d2d_trace=d2d_trace)
...
quad_display(iterations_list, average_throughput_list, 'blue', 'Param-2', 
        average_throughput_list_1, 'green', 'Param-4', 
        average_throughput_list_2, 'red', 'Param-6', 
        average_throughput_list_3, 'black', 'Param-8', 
